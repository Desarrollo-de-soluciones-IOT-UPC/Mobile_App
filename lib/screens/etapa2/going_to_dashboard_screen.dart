...
/// Reconstrucción responsive con blur/glass basada en el CSS pegado.
        ...
        child: SizedBox(
          ...
          child: Stack(
            ...
            children: [
              ...
              Positioned(
                ...
                child: Container(
                  decoration: BoxDecoration(
                    ...
                    border: const Border(
                      bottom: BorderSide(color: Color.fromRGBO(66, 70, 85, 0.2), width: 1),
                    ),
                    boxShadow: [
                      BoxShadow(
                      ...
                      Padding(
                        ...
                        child: Row(
                          ...
                          children: [
                            ...
                            // Right action (placeholder for the demo button area)
                            Container(
                              width: 32.72 * scale,
                              height: 24 * scale,
                            ...
                            child: DecoratedBox(
                              ...
                              child: Padding(
                                ...
                                child: ClipRRect(
                                  ...
                                  child: Stack(
                                    children: [
                                      // Technical visualization (sin imagen real del CSS)
                                      Positioned.fill(
                                        child: Container(
                                          decoration: BoxDecoration(
                                            borderRadius: BorderRadius.circular(12 * scale),
                ...
                child: Container(
                  ...
                  child: Stack(
                    children: [
                      ...
                      // Horizontal divider highlight at 0..16%
                      Positioned.fill(
                        child: Align(
              ...
              // Detailed Subtext & Status Box (approx placement)
              Positioned(
                left: 24 * scale,
                right: 24 * scale,
                top: 685 * scale,
              ...
              // Small contextual IBM Plex mono line (approx)
              Positioned(
                left: 24 * scale,
                top: 740 * scale,
                right: 24 * scale,

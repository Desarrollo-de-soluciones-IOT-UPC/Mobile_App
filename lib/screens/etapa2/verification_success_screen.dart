...
/// Basado en el CSS pegado: "Verification Success - EmSafe".
                                  ...
                                  children: [
                                    ...
                                    Positioned(
                                      ...
                                      child: Column(
                                        children: [
                                          Padding(
                                            padding: EdgeInsets.symmetric(horizontal: 2.31 * scale),
                                            child: Text(
                                          ...
                                          child: TextButton(
                                            onPressed: () {
                                              Navigator.of(context)
                                                  .pushNamed('/etapa2/going-to-dashboard');
                                            },
                                    ...
                                    // Contextual System Status Detail (Bento-lite)
                                    Positioned(
                                      top: 122 * scale,
                                      left: 24 * scale,
                                      right: 24 * scale,
